...
parser.add_argument('--config', default='experiments/sample_data/train_ladybug.yml', type=str, help='Specify a config file path')
...
parser.add_argument('--save_dir', default='/home/unsup3d/results/celeba', type = str, help = 'directory, that result will be saved')
